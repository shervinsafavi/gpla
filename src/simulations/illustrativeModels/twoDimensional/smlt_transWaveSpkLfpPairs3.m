function [lfpLikeSig, spikeTrains, map, varargout]= ...
    smlt_transWaveSpkLfpPairs3(globalDynamicsParams, spikeTrainParams, ...
...
waveParams.c = globalDynamicsParams.speed;

waveData = sim_WaveEqu2(stimVec, waveParams, 'edp_params',pdeParams);
...
% for it = 1000% : nSample
    tm = waveData(:,:, it);
    lfpLikeSig_inGridShape(:,:, it) = imgaussfilt(tm, globalDynamicsParams.spatSigma) + ...
        globalDynamicsParams.whiteNoise_sigma * randn(size(tm));
end
