...
for kModel = 1 : 2
    switch kModel
      case 1
        ...
        load(fullfile(pds.ldat, 'biophysWaveSimul',['neuralWaveStats1JLargeCenter' lfpExt{klfp}]), ...
      ...
      case 2
        ...
        load(fullfile(pds.ldat, 'biophysWaveSimul',['neuralWaveStats1SFJLargeCenter' lfpExt{klfp}]), ...
             'lfpVec','spkVec','gPLV','allStat','map','globalDynamicsParams','SF','Nbin')
