% difference with v1 is 
% direction phase gradient is corrected, 
% legened is changed
% some annotation/text has been changed
...
cmap_raw = parula(N); % colormap, with N colors
...
text(-15.5, 1.7, {'Weak', 'recurrent inhibition'}, 'HorizontalAlignment', 'center', 'FontWeight','normal', 'fontsize', vc.f13.schfs)
text(-15.5, .7, {'Strong', 'recurrent inhibition'}, 'HorizontalAlignment', 'center', 'FontWeight','normal', 'fontsize', vc.f13.schfs)
