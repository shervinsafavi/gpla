...
for kModel = 1 : 2
    switch kModel
      case 1
        ...
        fileName = fullfile(pds.ldat, 'biophysWaveSimul', 'simneuralwaveJLarge_28265.mat');
        fileNameSpk = fullfile(pds.ldat, 'biophysWaveSimul', 'spkHR_simneuralwaveJLarge_28265.mat');
      case 2
        coi = 3;  % col onset index - define which side of the figure it should locate
        
        fileName = fullfile(pds.ldat, 'biophysWaveSimul', 'simneuralwaveSFJLarge_13062.mat');
        fileNameSpk = fullfile(pds.ldat, 'biophysWaveSimul', 'spkHR_simneuralwaveSFJLarge_13062.mat');
    end
