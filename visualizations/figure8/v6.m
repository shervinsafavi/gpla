% in v6 we have better auestics and labeling
% and some fundamental changes regarind the plotting 
...
tos = .03; % temp offset
displaceFigureStuff(sbh, [tos NaN -tos NaN]);
